...
import { expressAuthentication } from './auth/jwtAuth';
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsPrivateController_privateRoute: Record<string, TsoaRoute.ParameterSchema> = {
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        };
        app.get('/private',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(PrivateController)),
            ...(fetchMiddlewares<RequestHandler>(PrivateController.prototype.privateRoute)),

            async function PrivateController_privateRoute(request: ExRequest, response: ExResponse, next: any) {
        ...
        const argsAuthController_verifyEmail: Record<string, TsoaRoute.ParameterSchema> = {
                body: {"in":"body","name":"body","required":true,"ref":"VerifyEmailInput"},
        };
